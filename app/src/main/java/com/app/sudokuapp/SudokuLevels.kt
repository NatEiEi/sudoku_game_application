...
object SudokuLevels {
    ...
    val LEVEL_2_INITIAL = arrayOf(
        intArrayOf(0, 5, 3, 6, 2, 0, 1, 0, 9),
        intArrayOf(0, 1, 6, 9, 3, 0, 4, 8, 5),
        intArrayOf(0, 9, 8, 0, 0, 5, 6, 2, 3),
        intArrayOf(0, 0, 7, 5, 9, 1, 8, 4, 2),
        intArrayOf(9, 0, 1, 0, 8, 6, 5, 0, 7),
        intArrayOf(5, 2, 6, 3, 0, 7, 9, 1, 8),
        intArrayOf(1, 3, 4, 7, 0, 9, 8, 5, 2),
        intArrayOf(8, 6, 0, 0, 5, 2, 0, 2, 4),
        intArrayOf(4, 7, 2, 8, 0, 0, 2, 6, 0)
    )
    ...
    val LEVEL_3_INITIAL = arrayOf(
        intArrayOf(0, 0, 0, 6, 7, 8, 0, 1, 2),
        intArrayOf(6, 7, 0, 1, 9, 0, 3, 4, 8),
        intArrayOf(1, 9, 8, 0, 4, 0, 5, 0, 7),
        intArrayOf(8, 0, 9, 7, 6, 0, 4, 0, 3),
        intArrayOf(0, 2, 6, 0, 0, 0, 7, 9, 1),
        intArrayOf(0, 1, 3, 9, 2, 4, 0, 0, 6),
        intArrayOf(9, 0, 1, 2, 3, 0, 4, 0, 7),
        intArrayOf(2, 0, 7, 4, 0, 9, 0, 3, 0),
        intArrayOf(0, 4, 0, 0, 8, 6, 1, 7, 0)
    )

    val LEVEL_3_SOLUTION = arrayOf(
        intArrayOf(5, 3, 4, 6, 7, 8, 9, 1, 2),
        intArrayOf(6, 7, 2, 1, 9, 5, 3, 4, 8),
        intArrayOf(1, 9, 8, 3, 4, 2, 5, 6, 7),
        intArrayOf(8, 5, 9, 7, 6, 1, 4, 2, 3),
    ...
    val LEVELS = listOf(
        ...
        Pair(LEVEL_3_INITIAL, LEVEL_3_SOLUTION),
        Pair(LEVEL_4_INITIAL, LEVEL_4_SOLUTION)
    )
